...
func (f *File) WriteAt(p []byte, off int64) (n int, err error) { return 0, errors.ErrUnsupported }
...
func (f *File) Truncate(size int64) error { return errors.ErrUnsupported }

func (f *File) WriteString(s string) (ret int, err error) { return 0, errors.ErrUnsupported }
